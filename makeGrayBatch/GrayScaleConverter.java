    ...
    public void selectAndConvert () {
        ...
        for (File f : dr.selectedFiles()) {
            ...
            ImageResource gray = makeGray(inImage);
                String initialname=inImage.getFileName();//get name of input file
                String finalname="gray-"+initialname;//create new file name
                gray.setFileName(finalname);//set grayscale image's name to new file name
         
                gray.save();//save grayscale image
        }
    }
